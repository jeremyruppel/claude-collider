---
name: songwriting
description: Music theory and songwriting reference for composing better patterns, melodies, bass lines, and chord voicings in SuperCollider.
---
...
- **scales.md** — Scales, modes, when to use each, SC usage
...
- Bass: octave 2–3
- Chords/pads: octave 3–4
- Melody/leads: octave 4–5
